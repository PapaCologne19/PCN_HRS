...
$appnoto= $_SESSION["appnoto1"];
   ...
   $resultap =mysql_query("SELECT * FROM employees where appno ='$appnoto'");
      while($rowap=mysql_fetch_row($resultap))
       {


   $resultap1 =mysql_query("SELECT * FROM deployment where appno_d ='$rowap[4]' and is_deleted !='1'");
      while($rowap1=mysql_fetch_row($resultap1))
       {
