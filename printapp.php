...
$appnoto= $_SESSION["appnoto"];
   ...
   $resultap =mysql_query("SELECT * FROM employees where appno ='$appnoto'");
...
<div class="form-group" >
       ...
       <hr>
       <center>
          <label><font color="Black" size="4">Applicant Information</font></label>
       </center>
         <hr>
	...
	<div class="form-group">
	 <p> <label >Applicant Number:</label>
  		<input type="text" name = "newshortlist" value= "'.$rowap[4].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly><p>
    </div>
	<div class="form-group" >
       <p> <label>Region:</label>
  		<input type="text" name = "newshortlist" value= "'.$rowap[12].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly></p>
    </div>
    	<div class="form-group" >
       <p> <label>Gender:</label>
  	  		<input type="text" name = "newshortlist" value= "'.$rowap[16].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly></p>
    </div>
    	<div class="form-group" >
	...
	<div class="form-group" >
       <p> <label>Civil Status:</label>
  		<input type="text" name = "newshortlist" value= "'.$rowap[17].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly></p>
    </div>
    	<div class="form-group" >
       ...
       <p> <label>TIN Number:</label>
    	...
    	<div class="form-group" >
       <p> <label>Desired Position:</label>
    		<input type="text" name = "newshortlist" value= "'.$rowap[21].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly></p>
    </div>
	<div class="form-group" >
       <p> <label>Email Address:</label>
  		<input type="text" name = "newshortlist" value= "'.$rowap[20].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly></p>
    </div>
    	<div class="form-group" >
       <p> <label>Joined Date:</label>
  		<input type="text" name = "newshortlist" value= "'.$rowap[3].'" class="form-group"  placeholder="" style= "height:35px;width:60%;" readonly></p>
    </div>
