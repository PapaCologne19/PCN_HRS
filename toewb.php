...
echo '
            ...
            <button class="button btn-success" Name ="alltoewb" style="float:right;width:200px;height:50px"><span>ALL TO EWB</span></button>
             </form>
...
$resultx1 = mysql_query("SELECT * FROM shortlist_master WHERE shortlistnameto = '$data'");
                  while($rowx1=mysql_fetch_row($resultx1))
                  {  
                     // $kekelpogi= $rowx1[2];

                  $resultx = mysql_query("SELECT * FROM employees WHERE appno = '$rowx1[2]'  ");
...
';
                                            ...
                                            ");
                                                      ...
                                                      $resultchk = mysql_query("select * from shortlist_master WHERE shortlistnameto = '$data' and appnumto='$rowx[4]' ");
                                                            if (mysql_num_rows($resultchk) == 0) {
                                                            // kapag wala pang user name na kaparehas
                                                                 ...
                                                                 mysql_query("UPDATE shortlist_master
                                                                  set 
