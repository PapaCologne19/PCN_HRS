...
<!--- laman -->
      <form action = "" method = "POST">
                   ...
                   <div class="form-group" >
                         ...
                         <input type="text" name = "clientname" class="form-control"  placeholder="" style= "height:45px;width:60%;">
                    </div>

                    <div class="form-group" >
                         <label>Area Coverage:</label>
                         <input type="text" name = "area_coverage" class="form-control"  placeholder="" style= "height:45px;width:60%;">
                    </div>

                    <div class="form-group" >
                         <label>Region of Coverage:</label>
                         <input type="text" name = "region_coverage" class="form-control"  placeholder="" style= "height:45px;width:60%;">
                    </div>
                    ...
                    <div class="form-group" >
                         ...
                         <input type="text" name = "client_status" class="form-control"  placeholder="" style= "height:45px;width:60%;">
                    </div>
      ...
      <form action = "" method = "POST">
                   ...
                   <div class="form-group" >
                    ...
                    <div class="form-group" >
                         ...
                         <input type="text" name = "clientname1" class="form-control"  placeholder="" style= "height:45px;width:60%;">
                    </div>
                    ...
                    <div class="form-group" >
                         ...
                         <input type="text" name = "statusofproject" class="form-control"  placeholder="" style= "height:45px;width:60%;">
                    </div>
